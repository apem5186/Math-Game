...
# 배포판 resorce_path 출처 #
# resorce_path : https://stackoverflow.com/questions/51264169/pyinstaller-add-folder-with-images-in-exe-file
# 배포판에서는 exe파일 생성을 위해 Sysfont의 매개변수를 None에서 "arialrounded"로 바꾸었습니다.
# 파일 절대경로 생성을 위해 resorce_path 함수를 참조하여 exe파일을 생성하였습니다.
